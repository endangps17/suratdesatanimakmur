...
<body>
  <?php
    ...
    if(isset($_GET['filter']) && ! empty($_GET['filter'])){
      ...
      if($filter == '1'){
        echo '
          <div class="header">
            <div align="center" style="font-size: 14pt;"><b>Laporan Surat Administrasi Desa - Surat Keluar Desa Tani Makmur</b></div>
            <hr>
          </div><br>
        ';
        ...
        echo '
          <div class="header">
            <div align="center" style="font-size: 12pt;"><b>Laporan Surat Administrasi Desa - Surat Keluar Desa Tani Makmur</b></div>
  ...
  <table width="100%" border="1" cellpadding="5" style="border-collapse:collapse;">
    ...
    <?php
      ...
      $query = "SELECT penduduk.nama, surat_keterangan.no_surat, surat_keterangan.keterangan, surat_keterangan.tanggal
          FROM surat_keterangan
          JOIN penduduk ON surat_keterangan.penduduk_id = penduduk.id";
