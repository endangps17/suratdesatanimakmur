                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <select name="frt" class="form-control" value="<?php echo $row['rt']; ?>" required>
                          ...
                          <option <?php if($row['rt'] == '007'){ echo 'selected'; } ?> value="006">007</option>
                          <option <?php if($row['rt'] == '008'){ echo 'selected'; } ?> value="006">008</option>
                          <option <?php if($row['rt'] == '009'){ echo 'selected'; } ?> value="006">009</option>
                          <option <?php if($row['rt'] == '010'){ echo 'selected'; } ?> value="006">010</option>
                          <option <?php if($row['rt'] == '011'){ echo 'selected'; } ?> value="006">011</option>
                          <option <?php if($row['rt'] == '012'){ echo 'selected'; } ?> value="006">012</option>
                          <option <?php if($row['rt'] == '013'){ echo 'selected'; } ?> value="006">013</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <select name="frw" class="form-control" value="<?php echo $row['rw']; ?>" required>
                          ...
                          <option <?php if($row['rw'] == '004'){ echo 'selected'; } ?> value="003">004</option>
                          <option <?php if($row['rw'] == '005'){ echo 'selected'; } ?> value="003">005</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
